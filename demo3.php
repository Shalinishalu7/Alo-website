        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL) === false){
            ...
            if($uploadStatus == 1){
                ...
                $htmlContent = '<h2>Contact Request Submitted</h2>
                    <p><b>Name:</b> '.$name.'</p>
                    <p><b>Email:</b> '.$email.'</p>
                    <p><b>Phone Number:</b> '.$txtPhoneNo.'</p>
       ...
       <?php } ?>
                                ...
                                <form action="" method="post" name="form" class="signin-form"
                                    ...
                                    <input type="text" placeholder="Name" name="name" id="name" required
                                            onkeydown="return /[a-z]/i.test(event.key)" value="<?php echo !empty($postData['name'])?$postData['name']:''; ?>" >

                                        <input type="number" placeholder="Contact Number" id="txtPhoneNo"
                                            name="txtPhoneNo" maxlength="10"
                                         oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                         value="<?php echo !empty($postData['txtPhoneNo'])?$postData['txtPhoneNo']:''; ?>">
                                        <input type="text" placeholder="Email" name="email" onblur="validate()"
                                            id="Email" value="<?php echo !empty($postData['email'])?$postData['email']:''; ?>">
                                        ...
                                        <!-- <select class="classic" placeholder="Position Applying For"  name="position[]" value="<?php echo !empty($postData['position'])?$postData['position']:''; ?>">
                                        ...
                                        <select class="classic mt-3" placeholder="Position Applying For" name="experience" value="<?php echo !empty($postData['experience'])?$postData['experience']:''; ?>">
                                        ...
                                        <input type="text" placeholder="Position" name="Position" id="name" required
                                            onkeydown="return /[a-z]/i.test(event.key)" value="<?php echo !empty($postData['Position'])?$postData['Position']:''; ?>" >


                                            <input type="text" placeholder="experience" name="experience" id="name" required
                                             value="<?php echo !empty($postData['experience'])?$postData['experience']:''; ?>" >
                                        ...
                                        <input type="file" class="mt-3" autocomplete="off" name="attachment"
                                            placeholder="Upload Resume" class="form-control" id="file" required>
                                    </div>
